	...
	<body>
        ...
        <div class="nav_content">
            <div class="wrapper">
                ...
                <a class="all_production" href="#"><span>Вся продукция</span></a>
            </div>
        </div>
        <div class="accessories_heading">
            <div class="wrapper">
                ...
                <a class="go_home" href="#">На главную</a>
            </div>
        </div>
       <div class="gray_bg">
           ...
           <div class="cat_main_cont">
               <div class="wrapper accessories">
                   <div class="block_center">
                       <div class="cat_items">
                               <ul class="items">
                                   <li>
                                       <div class="cat_img_holder">
                                           <img src="images/motor_oil.png" alt=""/>
                                       </div>
                                       <div class="cat_item_content">
                                           <a class="title" href="#">Моторное масло Shell Helix HX7
                                               10W/40, 4 л, полусинтетическое</a>
                                           <div class="cat_price">990 руб.</div>
                                           <a class="add_to_cart" href="#">В корзину</a>
                                       </div>
                                   </li>
                                   <li>
                                       <div class="cat_img_holder">
                           ...
                           <div class="clearfix"></div>
                           <a class="show_more" href="#">Показать еще</a>
                           <div class="accessories_switcher">
                               <ul>
                                   <li><a href="" class="curr_page">1</a></li>
                                   <li><a href="">2</a></li>
                                   <li><a href="">3</a></li>
                                   <li data-target="next"><a href="#">»</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
