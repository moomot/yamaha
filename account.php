                    ...
                    <ul>
                        <li>
                            <div class="account_title">
                                <div class="account_title_text">Персональные данные</div>
                                <a class="account_edit" href="#"></a>
                            </div>
                            <div class="account_cont">
                                Константин Константинопольский <br/>
                                +7 987 654-32-10 <br/>
                                <a href="mailto:fff">kostya@mail.ru</a> <br/>
                                <div>
                        ...
                        <li>
                            <div class="account_title">
                                <div class="account_title_text">Мои заказы</div>
                            </div>
                            <div class="account_cont">
                                <!-- order item -->
                                <div class="order_number">Заказ №32541</div>
                                <a href="#">Мотоцикл Yamaha MT-09 Tracer</a>
                                <a href="#">Мотоцикл Yamaha FJR1300A</a>
                                <div class="order_price">— 1 320 000 руб.</div>
                                <div class="order_status">Статус: ожидает оплаты</div>
                                <div class="order_hr"></div>
                                <!-- end order item -->
                                <!-- order item -->
                                <div class="order_number">Заказ №32542</div>
                                <a href="#">Мотоцикл Yamaha YZF-R6</a>
                                <div class="order_price">— 850 000 руб.</div>
                                <div class="order_status">Статус: <span>выполнено</span></div>
                                <!-- end order item -->
                            </div>
                        </li>
                        <li>
                            <div class="account_title">
                                <div class="account_title_text">Мои покупки</div>
                            </div>
                            <div class="account_cont">
                                <!-- order item -->
                                <div class="order_number">Заказ №32542</div>
                        ...
                        <li>
                            <div class="account_title">
                                <div class="account_title_text">Документы</div>
                            </div>
                            <div class="account_cont">
                                <!-- order item -->
                                <a href="#">Инструкция по эксплуатации</a>
                                <a href="#">Гарантия</a>
                                <!-- end order item -->
                            </div>
                        </li>
